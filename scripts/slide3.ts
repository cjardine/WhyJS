...
// import PartiOn from 'partiOn.js';
    ...
    function startParticles() {
        ...
        if (canvas) {
            ...
            party.addEmitter(envious(window.innerWidth * 0.8, window.innerHeight));
            party.setBackgroundColor('rgba(0,0,0,0.7)');
            party.setBlendMode(PartiOn.constants.canvas.blendModes.COLOR_DODGE);
